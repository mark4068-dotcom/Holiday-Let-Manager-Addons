...
Independent ferry-data integration for Holiday Let Manager. It collects official live status for five services: Red Funnel's Southampton–East Cowes vehicle ferry and Southampton–West Cowes Red Jet; plus Wightlink's Portsmouth Harbour–Ryde Pier Head FastCat, Portsmouth–Fishbourne vehicle ferry, and Lymington–Yarmouth vehicle ferry.
...
The official service-status pages are authoritative. Operator X feeds and interactive vessel maps are suitable future supplementary adapters, but are kept out of the core status path so their failure cannot interrupt HLM updates.
